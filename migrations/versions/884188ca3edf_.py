...
Revision ID: 884188ca3edf
Revises: 
Create Date: 2023-06-14 13:58:31.187412
...
def upgrade():
    ...
    with op.batch_alter_table('employees', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_employees_first_name'), ['first_name'], unique=True)
